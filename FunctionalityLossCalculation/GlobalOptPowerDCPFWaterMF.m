function [PowerSysFunLoss, WaterSysFunLoss, PowerComState, WaterComState, PowerZoneState, WaterZoneState] = GlobalOptPowerDCPFWaterMF...
...
idx_power_angle = E_p + Nsp + Ndp + NPdw+ (1:N_p);
...
Aeq3 = zeros(1,Nv); 
Aeq3(idx_power_angle(params.RefNode))=1;
...
Aeq5 = zeros(NPdw+NWdp,Nv);Aeq6 = zeros(NPdw+NWdp,Nv);
for i=1:NPdw
    Aeq5(i,idx_power2water_dem(i))=1; Aeq5(i,idx_power2water_state(i))=-Dpw(i,3);
    Aeq6(i,idx_power2water_state(i))=1; Aeq6(i,idx_waterInt_bin(PW_Index(i,2)))=-1;
end
for i=1:NWdp
    Aeq5(i,idx_water2power_dem(i))=1; Aeq5(i,idx_water2power_state(i))=-Dwp(i,3);
    Aeq6(i,idx_water2power_state(i))=1; Aeq6(i,idx_powerInt_bin(WP_Index(i,2)))=-1;
end
