...
%   interdependent power, gas and water systems. The operational state of
%   each system is assessed using a linear programming formulation: the gas
%   and water systems are modeled using a max flow approach, while the
%   power system uses a direct current (DC) power flow model.
%   Interdependency relationships between the systems trigger cascading
%   effects, which are iteratively updated.
%
% INPUTS:
