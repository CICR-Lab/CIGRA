function [SysFunLoss, ComState, ZoneState] = SingleNPConnectivity(CIS, CISComDamgScenario, params, TerminalZone)
% INTRODUCTION:
...
% system-wide,node-level and zone-level functionality based on Node Pair
% Connectivity Metric, considering damaged components. The output includes
% overall system loss and node-specific functionality before and after the
% event.
%
% INPUT:
