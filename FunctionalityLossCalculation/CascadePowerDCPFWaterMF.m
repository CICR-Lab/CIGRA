function [PowerSysFunLoss,WaterSysFunLoss, PowerComState, WaterComState, PowerZoneState, WaterZoneState, CascadeTrace] = CascadePowerDCPFWaterMF(...
...
%   interdependent power and water systems. The operational state of each
%   system is assessed using a linear programming formulation: the water
