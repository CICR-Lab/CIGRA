function [OptObj, BestDefendStrategy, BestAttackStrategy] = ComProtectDefenderLcAttackerRobDCPFOperator(System, DefenderParams, AttackerParams, OperatorParams, ComSet, varargin)
% ComProtectDefenderAttackerRobDCPFOperator
% --------------------------------------------------------
% Three-layer DAD model (Defender-Attacker-Defender) for DCPF systems
...
while UpperObj - LowerObj >= tolerance && iteration <= maxIterations
    ...
    [AttackStrategyNow, AttackCenterNow, SysFunLoss, ~] = ...
        LcAttackerRobDCPFOperator(System, ComSet, OperatorParams, TempAttackerParams, TerminalZone);
