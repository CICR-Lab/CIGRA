function [BestDefendStrategy,BestAttackStrategy,OptObj]=ComProtectDefenderNLcAttackerRobMFOperator(System,DefenderParams,AttackerParams,OperatorParams)
...
while UpperObj-LowerObj>=0.0001
    ...
    [BestAttackStrategy,~,temp_lower_obj]=NLcAttackerRobMFOperator(System,TempAttackerParams,OperatorParams);
    ...
    if ~isempty(AttackStrategies)
        while check_repeat_solution(AttackStrategies,BestAttackStrategy)==1
            ...
            [BestAttackStrategy,~] = NLcAttackerRobMFOperator(System,TempAttackerParams,OperatorParams);
        end
    end
