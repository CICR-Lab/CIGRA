function [PowerRetroID, WaterRetroID, PowerSysResGain, WaterSysResGain, PowerZoneResGain, WaterZoneResGain] = RuleRetrofitPowerWaterSeismicResilience...
    (PowerSystem, WaterSystem,PowerWaterInterdependency, SeismicMagnitudeEpicenter, TerminalZone, params)
% INTRODUCTION
%   Perform rule-based retrofit selection for interdependent power and
%   water systems (nodes only). The function constructs an undirected
...
retroVarIn = {PowerRetroID,WaterRetroID};
...
[PSysResB, WSysResB,PZoneResB,WZoneResB] = ComputeRuleBasedPowerWaterResilienceLoss(PowerSystem,WaterSystem,PowerWaterInterdependency,...
...
[PSysResA, WSysResA,PZoneResA,WZoneResA] = ComputeRuleBasedPowerWaterResilienceLoss(PowerSystem,WaterSystem,...
...
function [PowerSysRes, WaterSysRes, PowerZoneRes, WaterZoneRes] = ComputeRuleBasedPowerWaterResilienceLoss(PowerSystem,WaterSystem,PowerWaterInterdependency,...
    PowerComDamgScenario,WaterComDamgScenario,TerminalZone,params)
% INTRODUCTION
%   Computes the expected resilience loss of interdependent power and water
...
%   represent the expected resilience loss of power and water systems
