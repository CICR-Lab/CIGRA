function [PowerSysRes, WaterSysRes, PowerZoneRes, WaterZoneRes] = EvaluatePowerWaterSeismicRes(PowerSystem,WaterSystem,PowerWaterInterdependency,...
...
%   power and water systems at both system and zone levels. Given seismic
...
%                      Strategy-specific:
%                        .PowerRuleType, .WaterRuleType / .ScheMethod, etc., as required by your subroutines
%
...
if nargin < 6
    error(['EvaluatePowerWaterSeismicRes: not enough input args. ', ...
        'Need PowerSystem, WaterSystem, PowerWaterInterdependency, SeismicScenario, TerminalZone, params.']);
end
...
for i=1:params.numSim
            ...
            switch params.PowerFunMetric
                case 'DCPF'
                    [PowerResLoss, WaterResLoss, PowerSysFunsEvo, WaterSysFunsEvo, PowerRepairSeq, WaterRepairSeq, PowerZoneStateEvo, WaterZoneStateEvo]...
                        = RuleRepairPowerDCPFWaterMF(PowerSystem, WaterSystem, PowerWaterInterdependency, PowerCISComDamgScenario, WaterCISComDamgScenario, TerminalZone, params);
                case 'MF'
                    [PowerResLoss, WaterResLoss, PowerSysFunsEvo, WaterSysFunsEvo, PowerRepairSeq, WaterRepairSeq, PowerZoneStateEvo, WaterZoneStateEvo] ...
                        = RuleRepairPowerMFWaterMF (PowerSystem, WaterSystem, PowerWaterInterdependency, PowerCISComDamgScenario, WaterCISComDamgScenario, TerminalZone, params);
            end
        case 'Heuristic'
            switch params.PowerFunMetric
                case 'DCPF'
    ...
    PowerSysFunsEvoAll{i} = PowerSysFunsEvo;   WaterSysFunsEvoAll{i} = WaterSysFunsEvo;
    PowerSysResLossAll{i} = PowerResLoss;      WaterSysResLossAll{i} = WaterResLoss;
    PowerRepairSeqAll{i}  = PowerRepairSeq;    WaterRepairSeqAll{i}  = WaterRepairSeq;
    PowerZoneStateEvoAll{i}= PowerZoneStateEvo;  WaterZoneStateEvoAll{i}  = WaterZoneStateEvo;
