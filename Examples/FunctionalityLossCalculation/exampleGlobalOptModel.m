...
switch InterCIS_Type
    case 'PowerGas'
        switch Power_Model_Type
            case 'MF'
                [PowerSysFunLoss, GasSysFunLoss, PowerComState, GasComState, PowerZoneState, GasZoneState] = GlobalOptPowerMFGasMF...
                    (PowerSystem, GasSystem, PowerGasInterdependency, PowerCISComDamgScenario, GasCISComDamgScenario, TerminalZone, params);
            case 'DCPF'
                [PowerSysFunLoss, GasSysFunLoss, PowerComState, GasComState, PowerZoneState, GasZoneState] = GlobalOptPowerDCPFGasMF...
                    (PowerSystem, GasSystem, PowerGasInterdependency, PowerCISComDamgScenario, GasCISComDamgScenario, TerminalZone, params);
        end
    case 'PowerWater'
        switch Power_Model_Type
            case 'MF'
                [PowerSysFunLoss, WaterSysFunLoss, PowerComState, WaterComState, PowerZoneState, WaterZoneState] = GlobalOptPowerMFWaterMF...
                    (PowerSystem, WaterSystem, PowerWaterInterdependency, PowerCISComDamgScenario, WaterCISComDamgScenario, TerminalZone, params);
            case 'DCPF'
                [PowerSysFunLoss, WaterSysFunLoss, PowerComState, WaterComState, PowerZoneState, WaterZoneState] = GlobalOptPowerDCPFWaterMF...
                    (PowerSystem, WaterSystem, PowerWaterInterdependency, PowerCISComDamgScenario, WaterCISComDamgScenario, TerminalZone, params);
        end
    case 'PowerGasWater'
        switch Power_Model_Type
...
mapMultipleCISLayout2D(AreaBoundary, InterdependentSystem, 'Flow', opts);
% display systems in 3D space
mapMultipleCISLayout3D(AreaBoundary, InterdependentSystem, 'Flow', opts);
