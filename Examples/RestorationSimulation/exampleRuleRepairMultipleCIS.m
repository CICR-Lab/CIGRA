...
Power_RuleType = 'degree'; % degree | betweenness | proximity | custom
Gas_RuleType = 'degree'; % degree | betweenness | proximity | custom
Water_RuleType = 'degree'; % degree | betweenness | proximity | custom
Repair_Crew=[1 1 1]; %% [P, G, W] or [P, G] or [P, W]
Power_RepairOrder=[1,3,2,4]; %% Required only if the RuleType='custom';
Gas_RepairOrder=[2,1];
Waters_RepairOrder=[1,2];
Scenario_ID=1;
%% set parameters and initialize
params=struct;
params.RepairCrew = Repair_Crew;
params.PowerRuleType = Power_RuleType;
params.GasRuleType = Gas_RuleType;
params.WaterRuleType = Water_RuleType;
params.PowerRepairOrder =Power_RepairOrder;
params.GasRepairOrder =Gas_RepairOrder;
params.WaterRepairOrder =Waters_RepairOrder;
...
col_gas   = [0.22, 0.49, 0.72]; 
col_water = [0.99, 0.55, 0.38]; 
