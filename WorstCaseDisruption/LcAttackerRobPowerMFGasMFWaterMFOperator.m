function [AttackStrategy, AttackCenter, PowerSysFunLoss, GasSysFunLoss, WaterSysFunLoss, PowerComState,  GasComState,  WaterComState] = ...
          LcAttackerRobPowerMFGasMFWaterMFOperator(PowerSystem, GasSystem, WaterSystem, PowerGasInterdependency, PowerWaterInterdependency, ComSet, params, AttackPara, TerminalZone)
% INTRODUCTION:
%   Searches for the component set that maximises the combined
%   functionality loss of interdependent power, gas and water systems based on MF model.
%   Each candidate in ComSet is evaluated with GlobalOptRobMFPowerMFGasMFWaterModel.
%
% INPUT:
%   PowerSystem, GasSystem, WaterSystem  – CIS-style structs (see GlobalOptRobMFPowerMFGasMFWaterModel).
...
%   params                  – passed to GlobalOptRobMFPowerMFGasMFWaterModel.
...
%   PowerSysFunLoss, GasSysFunLoss, WaterSysLoss – 1×3 vectors from GlobalOptRobMFPowerMFGasMFWaterModel.
