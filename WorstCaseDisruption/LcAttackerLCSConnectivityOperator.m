function [AttackStrategy, AttackCenter, SysFunLoss, ComState] = LcAttackerLCSConnectivityOperator(CIS, ComSet, params, AttackPara, TerminalZone)
% INTRODUCTION:
% This function simulates an attacker seeking the worst-case 
% damage scenario based on largest component size metirc that causes the largest drop in node-level functionality.
...
for nc = 1:size(ComSet, 1)
    ...
    [SysFunLossNow, ComStateNow] = SingleLCSConnectivity(CIS, CISComDamgScenario, params, TerminalZone);
