function [ResLoss, SysFunsEvo, RepairSeq, ZoneStateEvo] = RuleRepairSingleMF(CIS, CISComDamgScenario, TerminalZone, params)
% INTRODUCTION:
...
%   is evaluated using max flow model. The function then constructs the functionality
%   recovery curve over time and calculates the corresponding resilience loss.
%   
%
% INPUT:
