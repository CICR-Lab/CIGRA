function [ResLoss, SysFunsEvo, RepairSeq, ZoneStateEvo] = HeuristicRepairSingleDCPF(CIS, CISComDamgScenario, TerminalZone, params)
% INTRODUCTION:
...
switch params.ScheMethod
    case 'GA'
        [ResLoss, SysFunsEvo, RepairSeq, ZoneStateEvo] = GABasedRepairSchedulingSingleDCPF(CIS, CISComDamgScenario, TerminalZone, params);
    case 'SA'
        [ResLoss, SysFunsEvo, RepairSeq, ZoneStateEvo] = SABasedRepairSchedulingSingleDCPF(CIS, CISComDamgScenario, TerminalZone, params);
end
end


function [ResLoss, SysFunsEvo, RepairSeq, ZoneStateEvo] = GABasedRepairSchedulingSingleDCPF(CIS, CISComDamgScenario, TerminalZone, params)
% INTRODUCTION:
...
if Ndm <= RR 
    ...
    for i = 1:params.GANumInd
        ...
        [~, resloss] = computeRestorationCurveSingleDCPF(CIS,repairseq,CISComDamgScenario, TerminalZone,params);
        ObjVC(i,1) = resloss(1);
    end
...
function [ResLoss, SysFunsEvo, RepairSeq, ZoneStateEvo] = SABasedRepairSchedulingSingleDCPF(CIS, CISComDamgScenario, TerminalZone, params)
% INTRODUCTION:
...
%
% INPUT:
%   CIS, CISComDamgScenario, TerminalZone, params : Same as main. SA fields used.
%
% OUTPUT:
%   ResLoss, SysFunsEvo, RepairSeq,ZoneStateEvo : Same definitions as main function.
