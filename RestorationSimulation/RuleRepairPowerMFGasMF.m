function [PowerResLoss, GasResLoss, PowerSysFunsEvo, GasSysFunsEvo, PowerRepairSeq, GasRepairSeq, PowerZoneStateEvo, GasZoneStateEvo] ...
    = RuleRepairPowerMFGasMF (PowerSystem, GasSystem, PowerGasInterdependency, PowerComDamgScenario, GasComDamgScenario, TerminalZone, params)
% INTRODUCTION:
...
%   using  max-flow models. The function tracks the recovery trajectories
%    of both systems and computes their corresponding resilience losses.
