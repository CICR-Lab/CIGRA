function [PowerResLoss, WaterResLoss, PowerSysFunsEvo, WaterSysFunsEvo, PowerRepairSeq, WaterRepairSeq, PowerZoneStateEvo, WaterZoneStateEvo]...
    = RuleRepairPowerDCPFWaterMF(PowerSystem, WaterSystem, PowerWaterInterdependency, PowerComDamgScenario, WaterComDamgScenario, TerminalZone, params)
% INTRODUCTION:
%   Simulates post-disaster restoration for interdependent power and
...
%   using DC power flow (for power) and max-flow models (for water).
...
%       filtered by SysType = 1 (power),  3 (water) respectively.
...
OrderFields = {'PowerRepairOrder','WaterRepairOrder'};
for k = 1:2
...
Integrated_schedule=[PowerRepairSeq;WaterRepairSeq];
