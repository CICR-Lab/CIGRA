function [PowerResLoss, GasResLoss, PowerSysFunsEvo, GasSysFunsEvo, PowerRepairSeq, GasRepairSeq, PowerZoneStateEvo, GasZoneStateEvo]...
    = HeuristicPowerDCPFGasMF(PowerSystem, GasSystem, PowerGasInterdependency,PowerComDamgScenario, GasComDamgScenario, TerminalZone, params)
% INTRODUCTION:
...
%   (for power) and max-flow models (for gas).
%
% INPUT:
...
switch params.ScheMethod
    case 'GA'
        [PowerResLoss, GasResLoss, PowerSysFunsEvo, GasSysFunsEvo, PowerRepairSeq, GasRepairSeq, PowerZoneStateEvo, GasZoneStateEvo] ...
            = GABasedRepairSchedulingPowerDCPFGasMF (PowerSystem, GasSystem, PowerGasInterdependency, PowerComDamgScenario, GasComDamgScenario, TerminalZone,  params);
    case 'SA'
        [PowerResLoss, GasResLoss, PowerSysFunsEvo, GasSysFunsEvo, PowerRepairSeq, GasRepairSeq, PowerZoneStateEvo, GasZoneStateEvo] ...
            = SABasedRepairSchedulingPowerDCPFGasMF (PowerSystem, GasSystem,PowerGasInterdependency, PowerComDamgScenario, GasComDamgScenario, TerminalZone, params);
end
end
...
if Ndm_power <= RR_power && Ndm_gas <= RR_gas
    ...
    for i = 1:params.GANumInd
        ...
        [~, ~, pLoss, gLoss] = computeRestorationCurvePowerDCPFGasMF(repairseq, PowerSystem, GasSystem, ...
